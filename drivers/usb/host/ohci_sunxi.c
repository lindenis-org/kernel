...
static int sunxi_insmod_ohci(struct platform_device *pdev)
{
	...
	if (sunxi_ohci->wakeup_suspend)
		scene_lock_init(&ohci_standby_lock[sunxi_ohci->usbc_no],
					SCENE_USB_STANDBY,  "ohci_standby");
#endif
