...
static int mbus_pmu_probe(struct platform_device *pdev)
{
	...
	hw_mbus_pmu.hwmon_dev = devm_hwmon_device_register_with_groups(&pdev->dev, "mbus_pmu", NULL, mbus_groups);
