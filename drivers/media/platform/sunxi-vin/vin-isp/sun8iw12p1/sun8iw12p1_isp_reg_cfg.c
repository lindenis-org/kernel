...
void sun8iw12p1_isp_module_enable(unsigned long id, unsigned int modules)
{
	sun8iw12p1_isp_regs[id].sun8iw12p1_isp_en->dwval |= modules;
}

void sun8iw12p1_isp_module_disable(unsigned long id, unsigned int modules)
{
	sun8iw12p1_isp_regs[id].sun8iw12p1_isp_en->dwval &= ~modules;
}

void sun8iw12p1_isp_set_wdr_mode(unsigned long id, unsigned int wdr_mode)
{
	if (wdr_mode == 1) {/*dol*/
...
unsigned int sun8iw12p1_isp_load_update_flag(unsigned long id)
{
...
static struct isp_bsp_fun_array sun8iw12p1_fun_array = {
	...
	.isp_set_last_blank_cycle = sun8iw12p1_isp_set_last_blank_cycle,
	...
	.isp_module_enable = sun8iw12p1_isp_module_enable,
	.isp_module_disable = sun8iw12p1_isp_module_disable,
	.isp_set_wdr_mode = sun8iw12p1_isp_set_wdr_mode,
	.isp_set_input_fmt = sun8iw12p1_isp_set_input_fmt,
	.isp_set_size = sun8iw12p1_isp_set_size,
	.isp_load_update_flag = sun8iw12p1_isp_load_update_flag,
};
