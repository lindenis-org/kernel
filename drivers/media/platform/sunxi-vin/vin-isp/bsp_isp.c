...
void bsp_isp_debug_output_cfg(unsigned long id, int enable, int sel)
{
	fun_array_curr->isp_debug_output_cfg(id, enable, sel);
}
...
{
	return fun_array_curr->isp_load_update_flag(id);
}
