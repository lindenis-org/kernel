...
#define AC108_ADC_PATTERN_SEL	0		//0:ADC normal,  1:0x5A5A5A,  2:0x123456,  3:0x000000,  4~7:I2S_RX_DATA,  other:reserved
...
#define AC108_LRCK_PERIOD		(AC108_SLOT_WIDTH*4)	//range[1, 1024], default PCM mode, I2S/LJ/RJ mode shall divide by 2
...
static int ac108_hw_params(struct snd_pcm_substream *substream, struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
	...
	ac108_read(SYSCLK_CTRL, &i, i2c_clt[0]);
